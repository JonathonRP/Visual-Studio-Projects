                ...
                <InsertItemTemplate>
                    <div class="col-sm-1 mgo-formview-form-group">
                        <div class="input-group input-group-sm">
                            <asp:TextBox ID="txtCustID" CssClass="form-control input-sm" runat="server" Text='<%# Bind("Cust_ID") %>' PlaceHolder="ID" />
                    ...
                    <div class="col-sm-3 mgo-formview-form-group">
                        <div class="input-group input-group-sm">
                            <asp:TextBox ID="txtCustFName" CssClass="form-control input-sm" runat="server" Text='<%# Bind("Cust_FName") %>' PlaceHolder="First Name" />
                            <div class="input-group-addon">
                    ...
                    <div class="col-sm-3 mgo-formview-form-group">
                        <div class="input-group input-group-sm">
                            <asp:TextBox ID="txtCustLName" CssClass="form-control input-sm" runat="server" Text='<%# Bind("Cust_LName") %>' PlaceHolder="Last Name" />
                            <div class="input-group-addon">
                    ...
                    <div class="col-sm-3 mgo-formview-form-group">
                        <div class="input-group input-group-sm">
                            <asp:TextBox ID="txtCustEMail" CssClass="form-control input-sm" runat="server" Text='<%# Bind("Cust_EMail") %>' PlaceHolder="EMail Address" />
                            <div class="input-group-addon">
                    ...
                    <div class="col-sm-3 mgo-formview-form-group">
                        <div class="input-group input-group-sm">
                            <asp:TextBox ID="txtCustStreet1" CssClass="form-control input-sm" runat="server" Text='<%# Bind("Cust_Street1") %>' PlaceHolder="Street1" />
                            <div class="input-group-addon">
                    ...
                    <div class="col-sm-1 mgo-formview-form-group">
                        <asp:TextBox ID="txtCustStreet2" CssClass="form-control input-sm" runat="server" Text='<%# Bind("Cust_Street2") %>' PlaceHolder="Street2" />
                    </div>
                    <div class="col-sm-2 mgo-formview-form-group">
                        <div class="input-group input-group-sm">
                            <asp:TextBox ID="txtCustCity" CssClass="form-control input-sm" runat="server" Text='<%# Bind("Cust_City") %>' PlaceHolder="City" />
                            <div class="input-group-addon">
                    ...
                    <div class="col-sm-2 mgo-formview-form-group">
                        <div class="input-group input-group-sm">
                            <asp:TextBox ID="txtCustState" CssClass="form-control input-sm" runat="server" Text='<%# Bind("Cust_State") %>' PlaceHolder="State" />
                            <div class="input-group-addon">
                    ...
                    <div class="col-sm-2 mgo-formview-form-group">
                        <div class="input-group input-group-sm">
                            <asp:TextBox ID="txtCustZIP" CssClass="form-control input-sm" runat="server" Text='<%# Bind("Cust_ZIP") %>' PlaceHolder="ZIP" />
                            <div class="input-group-addon">
                    ...
                    <div class="col-sm-2">
                        <asp:Button CssClass="btn btn-primary btn-sm" ID="btnFrmViewProductsInsert" runat="server" CausesValidation="True" CommandName="Insert" Text="Insert" ValidationGroup="form_view_validate" />
                        <asp:Button CssClass="btn btn-default btn-sm" ID="btnFrmViewProductsCancelInsert" runat="server" CausesValidation="False" CommandName="Cancel" Text="Cancel" />
                    </div>
                </InsertItemTemplate>
                <ItemTemplate>
                    <asp:Button ID="btnFrmViewCustomersNew" CssClass="btn btn-primary btn-sm" runat="server" CausesValidation="False" CommandName="New" Text="New Customer" />
                </ItemTemplate>
            </asp:FormView>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="table-responsive ">
                <asp:GridView ID="grdviewCustInfo" runat="server" CssClass="table table-hover table-striped table-condensed" AllowSorting="True" AutoGenerateColumns="False" DataSourceID="EntityCustomers" GridLines="None" OnPreRender="grdviewCustInfo_PreRender" OnRowDataBound="grd_RowDataBound" OnRowUpdated="grdviewCustInfo_RowUpdated" OnRowDeleted="grdviewCustInfo_RowDeleted">
                    <Columns>
                        <asp:BoundField DataField="Cust_ID" ReadOnly="true" HeaderText="Customer ID" SortExpression="Cust_ID" HeaderStyle-CssClass="col-sm-2"></asp:BoundField>
                        <asp:TemplateField HeaderText="Customer Name" SortExpression="Cust_FName" HeaderStyle-CssClass="col-sm-2">
                            <EditItemTemplate>
                                <div class="input-group input-group-sm">
                                    <asp:TextBox ID="grdCustFirstName" CssClass="form-control input-sm" runat="server" Text='<%# Bind("Cust_FName") %>' PlaceHolder="First Name"></asp:TextBox>
                                    <div class="input-group-addon">
                                ...
                                <div class="input-group input-group-sm">
                                    <asp:TextBox ID="grdCustLastName" CssClass="form-control input-sm" runat="server" Text='<%# Bind("Cust_LName") %>' PlaceHolder="Last Name"></asp:TextBox>
                                    <div class="input-group-addon">
                        ...
                        <asp:TemplateField HeaderText="Customer Address" SortExpression="Cust_Street1" HeaderStyle-CssClass="col-sm-4">
                            <EditItemTemplate>
                                <div class="col-sm-7 mgo-gridview-form-group">
                                    <div class="input-group input-group-sm">
                                        <asp:TextBox ID="grdCustStreet1" CssClass="form-control input-sm" runat="server" Text='<%# Bind("Cust_Street1") %>' PlaceHolder="Street 1"></asp:TextBox>
                                        <div class="input-group-addon">
                                ...
                                <div class="col-sm-5 mgo-gridview-form-group">
                                    <asp:TextBox ID="grdCustStreet2" CssClass="form-control input-sm" runat="server" Text='<%# Bind("Cust_Street2") %>' PlaceHolder="Street 2"></asp:TextBox>
                                </div>
                                <div class="col-sm-5 mgo-gridview-form-group">
                                    <div class="input-group input-group-sm">
                                        <asp:TextBox ID="grdCustCity" CssClass="form-control input-sm" runat="server" Text='<%# Bind("Cust_City") %>' PlaceHolder="City"></asp:TextBox>
                                        <div class="input-group-addon">
                                ...
                                <div class="col-sm-3 mgo-gridview-form-group">
                                    <div class="input-group input-group-sm">
                                        <asp:TextBox ID="grdCustState" CssClass="form-control input-sm" runat="server" Text='<%# Bind("Cust_State") %>' PlaceHolder="State"></asp:TextBox>
                                        <div class="input-group-addon">
                                ...
                                <div class="col-sm-4 mgo-gridview-form-group">
                                    <div class="input-group input-group-sm">
                                        <asp:TextBox ID="grdCustZIP" CssClass="form-control input-sm" runat="server" Text='<%# Bind("Cust_ZIP") %>' PlaceHolder="ZIP"></asp:TextBox>
                                        <div class="input-group-addon">
                        ...
                        <asp:TemplateField HeaderText="Customer EMail" SortExpression="Cust_EMail" HeaderStyle-CssClass="col-sm-1">
                            <EditItemTemplate>
                                <div class="input-group input-group-sm">
                                    <asp:TextBox ID="grdCustEMail" CssClass="form-control input-sm" runat="server" Text='<%# Bind("Cust_EMail") %>' PlaceHolder="EMail"></asp:TextBox>
                                    <div class="input-group-addon">
