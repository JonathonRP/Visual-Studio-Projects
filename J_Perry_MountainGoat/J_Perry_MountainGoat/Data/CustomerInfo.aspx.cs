...
namespace MGO.Data
{
    public partial class CustomerInfo : System.Web.UI.Page
    {
        ...
        protected void grdviewCustInfo_PreRender(object sender, EventArgs e)
        {
        ...
        protected void grdviewCustInfo_RowDeleted(object sender, GridViewDeletedEventArgs e)
        {
            if (e.Exception != null)
            {
        ...
        protected void grdviewCustInfo_RowUpdated(object sender, GridViewUpdatedEventArgs e)
        {
            if (e.Exception != null)
            {
                DatabaseErrorMessage = e.Exception.Message;
        ...
        {
            args.IsValid = args.Value.Length > 2 ? false : true;
        }
        protected void FrmViewCustomer_CustomerInserted(object sender, FormViewInsertedEventArgs e)
        {
            if (e.Exception != null)
            {
                DatabaseErrorMessage = e.Exception.Message;
