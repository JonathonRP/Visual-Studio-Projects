...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row mgo-row">
        <div class="col-sm-12">
            <asp:FormView ID="FrmViewEmployee" CssClass="form-inline pull-left" runat="server" DataKeyNames="Emp_ID" DataSourceID="EntityEmployees" GridLines="None" OnItemInserted="FrmViewEmployee_EmployeeInserted">
                <InsertItemTemplate>
                    <div class="col-sm-1 mgo-formview-form-group">
                        <div class="input-group input-group-sm">
                            <asp:TextBox ID="txtEmpID" CssClass="form-control input-sm" runat="server" Text='<%# Bind("Emp_ID") %>' PlaceHolder="ID" />
                    ...
                    <div class="col-sm-2 mgo-formview-form-group">
                        <div class="input-group input-group-sm">
                            <asp:TextBox ID="txtEmpFName" CssClass="form-control input-sm" runat="server" Text='<%# Bind("Emp_FName") %>' PlaceHolder="First Name" />
                            <div class="input-group-addon">
                    ...
                    <div class="col-sm-2 mgo-formview-form-group">
                        <div class="input-group input-group-sm">
                            <asp:TextBox ID="txtEmpLName" CssClass="form-control input-sm" runat="server" Text='<%# Bind("Emp_LName") %>' PlaceHolder="Last Name" />
                            <div class="input-group-addon">
                    ...
                    <div class="col-sm-2 mgo-formview-form-group">
                        <div class="input-group input-group-sm">
                            <asp:TextBox ID="txtEmpPosition" CssClass="form-control input-sm" runat="server" Text='<%# Bind("Emp_Position") %>' PlaceHolder="Position" />
                            <div class="input-group-addon">
                    ...
                    <div class="col-sm-2 mgo-formview-form-group">
                        <div class="input-group input-group-sm">
                            <asp:TextBox ID="txtEmpCommission" CssClass="form-control input-sm" runat="server" Text='<%# Bind("Emp_Commission") %>' PlaceHolder="Commission" />
                            <div class="input-group-addon">
                    ...
                    <div class="col-sm-2">
                        <asp:Button CssClass="btn btn-primary btn-sm" ID="btnFrmViewEmployeeInsert" runat="server" CausesValidation="True" CommandName="Insert" Text="Insert" ValidationGroup="form_view_validate" />
                        <asp:Button CssClass="btn btn-default btn-sm" ID="btnFrmViewEmployeeCancelInsert" runat="server" CausesValidation="False" CommandName="Cancel" Text="Cancel" />
                    </div>
                </InsertItemTemplate>
                <ItemTemplate>
                    <asp:Button ID="btnFrmViewEmployeeNew" CssClass="btn btn-primary btn-sm" runat="server" CausesValidation="False" CommandName="New" Text="New Employee" />
                </ItemTemplate>
            </asp:FormView>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="table-responsive">
                <asp:GridView ID="grdviewEmpInfo" runat="server" CssClass="table table-hover table-striped table-condensed" AutoGenerateColumns="False" DataSourceID="EntityEmployees" GridLines="None" AllowSorting="True" OnPreRender="grdviewEmpInfo_PreRender" OnRowDataBound="grd_RowDataBound" OnRowUpdated="grdviewEmpInfo_RowUpdated" OnRowDeleted="grdviewEmpInfo_RowDeleted">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Employee Name" SortExpression="Emp_FName" HeaderStyle-CssClass="col-sm-3">
                            <EditItemTemplate>
                                <div class="form-row">
                                    <div class="input-group input-group-sm">
                                        <asp:TextBox ID="grdEmpFirstName" CssClass="form-control input-sm" runat="server" Text='<%# Bind("Emp_FName") %>' PlaceHolder="First Name"></asp:TextBox>
                                        <div class="input-group-addon">
                                    ...
                                    <div class="input-group input-group-sm">
                                        <asp:TextBox ID="grdEmpLastName" CssClass="form-control input-sm" runat="server" Text='<%# Bind("Emp_LName") %>' PlaceHolder="Last Name"></asp:TextBox>
                                        <div class="input-group-addon">
                        ...
                        <asp:TemplateField HeaderText="Employee Position" SortExpression="Emp_Position" HeaderStyle-CssClass="col-sm-3">
                            <EditItemTemplate>
                                <div class="input-group input-group-sm">
                                    <asp:TextBox ID="grdEmpPosition" CssClass="form-control input-sm" runat="server" Text='<%# Bind("Emp_Position") %>' PlaceHolder="Position"></asp:TextBox>
                                    <div class="input-group-addon">
                        ...
                        <asp:TemplateField HeaderText="Employee Commission" SortExpression="Emp_Commission" HeaderStyle-CssClass="col-sm-2">
                            <EditItemTemplate>
                                <div class="input-group input-group-sm">
                                    <asp:TextBox ID="grdEmpCommission" CssClass="form-control input-sm" runat="server" Text='<%# Bind("Emp_Commission") %>' PlaceHolder="Commission"></asp:TextBox>
                                    <div class="input-group-addon">
