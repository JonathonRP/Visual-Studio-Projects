                ...
                <InsertItemTemplate>
                    <div class="col-sm-2 mgo-formview-form-group">
                        <div class="input-group input-group-sm">
                            <asp:TextBox ID="SKUTextBox" CssClass="form-control input-sm" runat="server" Text='<%# Bind("SKU") %>' PlaceHolder="SKU" />
                    ...
                    <div class="col-sm-3 mgo-formview-form-group">
                        <div class="input-group input-group-sm">
                            <asp:TextBox ID="Item_DescriptionTextBox" CssClass="form-control input-sm" runat="server" Text='<%# Bind("Item_Description") %>' PlaceHolder="Product Name" />
                            <div class="input-group-addon">
                    ...
                    <div class="col-sm-3 mgo-formview-form-group">
                        <div class="input-group input-group-sm">
                            <asp:DropDownList ID="ddlFormItemCatNum" AutoPostBack="true" CssClass="form-control input-sm" runat="server" DataSourceID="SqlCategories" DataTextField="Cat_Num" DataValueField="Cat_Num" OnPreRender="ddlFormItemCatNum_PreRender" OnSelectedIndexChanged="ddlFormItemCatNum_SelectedIndexChanged" SelectedValue='<%# Bind("Cat_Num") %>' />
                            <div class="input-group-addon">
                    ...
                    <div class="col-sm-2 mgo-formview-form-group">
                        <div class="input-group input-group-sm">
                            <asp:TextBox ID="Item_PriceTextBox" CssClass="form-control input-sm" runat="server" Text='<%# Bind("Item_Price") %>' PlaceHolder="Price" />
                            <div class="input-group-addon">
                    ...
                    <div class="col-sm-2 mgo-formview-form-group">
                        <asp:Button CssClass="btn btn-primary btn-sm" ID="btnFrmViewProductInsert" runat="server" CausesValidation="True" CommandName="Insert" Text="Insert" ValidationGroup="form_view_validate" />
                        <asp:Button CssClass="btn btn-default btn-sm" ID="btnFrmViewProductCancelInsert" runat="server" CausesValidation="False" CommandName="Cancel" Text="Cancel" />
                    </div>
                </InsertItemTemplate>
                <ItemTemplate>
                    <asp:Button ID="btnFrmViewProductNew" CssClass="btn btn-primary btn-sm" runat="server" CausesValidation="False" CommandName="New" Text="New Item" OnClick="btnFrmViewProducts_Click" />
                </ItemTemplate>
            </asp:FormView>
            <div class="col-sm-6">
                    ...
                    <EditItemTemplate>
                        <div class="col-sm-4 mgo-formview-form-group">
                            <div class="input-group input-group-sm">
                                ...
                                <asp:DropDownList ID="ddlFormCatNum" AutoPostBack="true" CssClass="form-control input-sm" runat="server" DataSourceID="SqlCategories" DataTextField="Cat_Num" DataValueField="Cat_Num" OnPreRender="ddlFormCatNum_PreRender" OnSelectedIndexChanged="ddlFormCatNum_SelectedIndexChanged" SelectedValue='<%# Bind("Cat_Num") %>' />
                            </div>
                        </div>
                        <div class="col-sm-5 mgo-formview-form-group">
                            <div class="input-group input-group-sm">
                                <div class="input-group-addon">
                                    <asp:Label runat="server">Category:</asp:Label>
                                </div>
                                <asp:TextBox ID="txtFormCat_Descript" runat="server" CssClass="form-control input-sm" Text='<%# Bind("Cat_Description") %>' />
                                <div class="input-group-addon">
                        ...
                        <asp:Button ID="btnFrmViewCategoryUpdate" CssClass="btn btn-primary btn-sm" runat="server" CausesValidation="True" CommandName="Update" Text="Update" ValidationGroup="form_view_validate" />
                        <asp:Button ID="btnFrmViewCategoryCancelUpdate" CssClass="btn btn-default btn-sm" runat="server" CausesValidation="False" CommandName="Cancel" Text="Cancel" />
                    </EditItemTemplate>
                    <InsertItemTemplate>
                        <div class="col-sm-4 mgo-formview-form-group">
                            <div class="input-group input-group-sm">
                                <asp:TextBox ID="Cat_NumTextBox" PlaceHolder="Category ID" runat="server" CssClass="form-control input-sm" Text='<%# Bind("Cat_Num") %>' />
                                <div class="input-group-addon">
                        ...
                        <div class="col-sm-5 mgo-formview-form-group">
                            <div class="input-group input-group-sm">
                                <asp:TextBox ID="Cat_DescriptionTextBox" PlaceHolder="Category" runat="server" CssClass="form-control input-sm" Text='<%# Bind("Cat_Description") %>' />
                                <div class="input-group-addon">
                        ...
                        <asp:Button ID="btnFrmViewCategoryInsert" CssClass="btn btn-primary btn-sm" runat="server" CausesValidation="True" CommandName="Insert" Text="Insert" ValidationGroup="form_view_validate" />
                        <asp:Button ID="btnFrmViewCategoryCancelInsert" CssClass="btn btn-default btn-sm" runat="server" CausesValidation="False" CommandName="Cancel" Text="Cancel" />
                    </InsertItemTemplate>
                    <ItemTemplate>
                        <asp:Button ID="btnFrmViewCategoryNew" CssClass="btn btn-primary btn-sm" runat="server" CausesValidation="False" CommandName="New" Text="New Category" />
                        <asp:Button ID="btnFrmViewCategoryEdit" CssClass="btn btn-default btn-sm" runat="server" CausesValidation="False" CommandName="Edit" Text="Edit Category" />
                    </ItemTemplate>
                </asp:FormView>
            </div>
                ...
                <EditItemTemplate>
                    <div class="col-lg-12">
                        <div class="form-group">
                            <asp:Button ID="btnFrmViewCategroyCancelDelete" CssClass="btn btn-default btn-sm" CausesValidation="false" CommandName="Cancel" runat="server" Text="Cancel" />
                            <asp:Button ID="btnFrmViewCategoryDeleteCategory" CssClass="btn btn-default btn-sm" CausesValidation="true" CommandName="Delete" runat="server" Text="Delete" OnClientClick="return confirm('Are you sure you want to delete this Category?');" />
                            <asp:DropDownList ID="DropDownList1" CssClass="form-control input-sm" runat="server" AutoPostBack="True" DataSourceID="SqlCategories" DataTextField="Cat_Num" DataValueField="Cat_Num" SelectedValue='<%# Bind("Cat_Num") %>' />
                        </div>
                    </div>
                </EditItemTemplate>
                <ItemTemplate>
                    <asp:Button ID="btnFrmViewCategoryDelete" CssClass="btn btn-default btn-sm" CausesValidation="false" CommandName="Edit" runat="server" Text="Delete Catagory" />
                </ItemTemplate>
            </asp:FormView>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="table-responsive">
                <asp:GridView ID="grdviewProducts" CssClass="table table-hover table-striped table-condensed" runat="server" AutoGenerateColumns="False" DataKeyNames="SKU" DataSourceID="SqlProducts" AllowSorting="True" OnPreRender="grdviewProducts_PreRender" OnRowDataBound="grd_RowDataBound" OnRowDeleted="grdProducts_RowDeleted" OnRowUpdated="grdProducts_RowUpdated" GridLines="None">
                    <Columns>
                        <asp:BoundField DataField="SKU" HeaderText="SKU" ReadOnly="True" SortExpression="SKU" HeaderStyle-CssClass="col-sm-2"></asp:BoundField>
                        <asp:TemplateField HeaderText="Product Name" SortExpression="Item_Description" HeaderStyle-CssClass="col-sm-3">
                            <EditItemTemplate>
                                <div class="input-group input-group-sm">
                                    <asp:TextBox ID="txtGridItemDescript" CssClass="form-control input-sm" runat="server" Text='<%# Bind("Item_Description") %>'></asp:TextBox>
                                    <div class="input-group-addon">
                        ...
                        <asp:TemplateField HeaderText="Category" SortExpression="Cat_Description" HeaderStyle-CssClass="col-sm-3">
                            <EditItemTemplate>
                                <div class="input-group input-group-sm">
                                    <asp:DropDownList ID="ddlGridItemCatNum" CssClass="form-control input-sm" AutoPostBack="true" runat="server" DataSourceID="SqlCategories" DataTextField="Cat_Num" DataValueField="Cat_Num" OnSelectedIndexChanged="ddlGridItemCatNum_SelectedIndexChanged" SelectedValue='<%# Bind("Cat_Num") %>' />
                                    <div class="input-group-addon">
                                        <asp:Label ID="lblGridItemCatDescript" runat="server" Text='<%# Bind("Cat_Description") %>'></asp:Label>
                                    </div>
                                </div>
                            </EditItemTemplate>
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Price" SortExpression="Item_Price" HeaderStyle-CssClass="col-sm-2">
                            <EditItemTemplate>
                                <div class="input-group input-group-sm">
                                    <asp:TextBox ID="txtGridItemPrice" CssClass="form-control input-sm" runat="server" Text='<%# Bind("Item_Price", "{0:F}") %>'></asp:TextBox>
                                    <div class="input-group-addon">
                        ...
                        <asp:TemplateField ShowHeader="False" ItemStyle-HorizontalAlign="center">
                            <EditItemTemplate>
                                <asp:LinkButton ID="LinkButton1" CssClass="btn btn-primary btn-sm" runat="server" CausesValidation="True" ValidationGroup="edit" CommandName="Update">
                                    <i class="glyphicon glyphicon-floppy-save"></i>
                                </asp:LinkButton>
                                <asp:LinkButton ID="LinkButton2" CssClass="btn btn-default btn-sm" runat="server" CausesValidation="False" CommandName="Cancel">
                                    <i class="glyphicon glyphicon-floppy-remove"></i>
                                </asp:LinkButton>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <asp:LinkButton ID="LinkButton1" CssClass="btn btn-primary btn-sm" runat="server" CausesValidation="False" CommandName="Edit">
                                    <i class="glyphicon glyphicon-edit"></i>
                                </asp:LinkButton>
                                <asp:LinkButton ID="LinkButton2" CssClass="btn btn-default btn-sm" runat="server" CausesValidation="False" CommandName="Delete">
