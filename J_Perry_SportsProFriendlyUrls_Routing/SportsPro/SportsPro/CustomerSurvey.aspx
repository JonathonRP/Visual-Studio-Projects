...
<asp:Content ID="main" runat="server" ContentPlaceHolderID="mainContent">
    ...
    <div class="form-group"><%-- Submit button --%>
        <div class="col-sm-4">
            ...
            <asp:Button ID="btnClear" runat="server" Text="Clear" Enabled="False" 
                ValidationGroup="Submit" CssClass="btn btn-primary" CausesValidation="false" OnClick="btnClear_Click" />
        </div>
        <div class="col-sm-7">
